...
function OrganiserDashboard() {
  ...
  const createEvent = async (e) => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:5000/api/organiser/events",
        {
          method: "POST",
          headers: {
  ...
  const viewSummary = async (eventId) => {
    try {
      ...
      let response = await fetch(
        `http://localhost:5000/api/organiser/events/${eventId}/summary`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!response.ok) {
        response = await fetch(
          `http://localhost:5000/api/events/${eventId}/summary`,
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
  ...
  const viewRevenue = async (eventId) => {
    try {
      ...
      let response = await fetch(
        `http://localhost:5000/api/events/${eventId}/revenue`,
        {
          method: "GET",
          headers: {
            Authorization: `Bearer ${token}`,
      ...
      if (!response.ok) {
        response = await fetch(
          "http://localhost:5000/api/organiser/revenue",
          {
            method: "GET",
            headers: {
              Authorization: `Bearer ${token}`,
